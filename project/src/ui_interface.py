...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.add_restauran_page = QtWidgets.QWidget()
        self.add_restauran_page.setObjectName("add_restauran_page")
        self.label_6 = QtWidgets.QLabel(parent=self.add_restauran_page)
        self.label_6.setGeometry(QtCore.QRect(160, 100, 231, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.stackedWidget_4.addWidget(self.add_restauran_page)
